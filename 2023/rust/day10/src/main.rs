...
fn main() {
    ...
    match fs::read_to_string("input/sample3.txt") {
        Ok(data) => println!("Part 2: sample 1 result: {}", part2::solve(data)),
        Err(e) => println!("Error reading sample input for part 2: {}", e),
    }
    match fs::read_to_string("input/sample4.txt") {
        Ok(data) => println!("Part 2: sample 2 result: {}", part2::solve(data)),
        Err(e) => println!("Error reading sample input for part 2: {}", e),
    }
    match fs::read_to_string("input/input.txt") {
